...
data class SettlementAgreementReportDto(
    ...
    val dormitoryStreetName: String,
    val dormitoryStreetNumber: String,
    ...
    fun toMap() = mapOf(
        ...
        "dormitoryStreetName" to this.dormitoryStreetName,
        "dormitoryStreetNumber" to this.dormitoryStreetNumber,
